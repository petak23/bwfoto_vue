...
<template>
	<my-settings />
	<main-menu-load :id_hlavne_menu_lang="id_hlavne_menu_lang" />
	<flash-message />
	<div
		id="slider"
		ref="myslider"
	...
	>
		...
		<div class="frame">
			<section id="webContent">
				...
				></button>
				<breadcrumb />
				<small v-if="store.user != null && store.user.id_user_roles > 3">
					<br />
					RouterView(id: {{ $route.params.id }}, {{ id_hlavne_menu_lang }})
					<br />
				</small>
				<RouterView />
			</section>
